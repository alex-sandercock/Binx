...
pub fn run_gwaspoly(
    ...
    if loco {
        // LOCO mode: compute chromosome-specific kinships
        let loco_kinships = compute_loco_kinship(&geno)?;
        ...
        for (chrom, marker_indices) in chrom_markers {
            ...
            // Test markers on this chromosome
...
fn test_marker_all_models_with_z(
...
fn align_kinship_to_genotypes_clone(
    kin: &KinshipMatrix,
    geno_ids: &[String],
